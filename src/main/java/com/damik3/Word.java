...
public class Word {
    ...
    String word;
    int level;
    List<Double> entropyVec;
    List<Integer> percentileVec;
    Double expectedEntropy;
    Double expectedWordsRemaining;
    Integer maxWordsRemaining;
    Integer numberOfGroups;
    Double prior;
    Tuple<Double> precomputedAverage;
    Double expectedAdditionalGuesses;
